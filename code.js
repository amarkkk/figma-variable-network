...
function getVariableType(collectionName) {
    // Return the collection name as-is for display
    return collectionName;
}
// Main scanning function
async function scanColorVariables() {
                ...
                if ('type' in value && value.type === 'VARIABLE_ALIAS') {
                    ...
                    if (aliasedVariable) {
                        ...
                        if (resolvedValue && typeof resolvedValue === 'object' && 'r' in resolvedValue) {
                            valuesHSBA[modeName] = colorToHSBA(resolvedValue);
                            valuesHEX[modeName] = colorToHEX(resolvedValue);
                        }
                        else {
                    ...
                    valuesHSBA[modeName] = colorToHSBA(value);
                    valuesHEX[modeName] = colorToHEX(value);
                }
            }
        }
